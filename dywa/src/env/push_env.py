...
from env.robot.trossen import Trossen
...
class PushEnv(EnvBase):
    ...
    class Config(EnvBase.Config):
        ...
        trossen: Trossen.Config = Trossen.Config()
    ...
    def __init__(self, cfg: Config,
        ...
        elif cfg.which_robot == 'trossen':
            self.robot_cfg = cfg.trossen
